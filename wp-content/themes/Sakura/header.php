...
<link rel="stylesheet" type="text/css" href="https://www.littlesilly.xyz/wp-content/themes/Sakura/inc/fonts/Bosk/Bosk.css">
				...
				<div class="site-top">
					<div class="site-branding">
						...
						<span class="site-title">
							<span class="logolink Bosk">
                                <a href="<?php bloginfo('url');?>">
                                <ruby>
                                <span class="sakuraso">Little</span>
                                <span class="no"></span>
                                <span class="shironeko">Silly</span>
                                <rp></rp>
