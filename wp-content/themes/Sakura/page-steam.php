...
<?php
$id = "76561198132639119";  // 你的SteamID，可以在这里获取 https://steamsignature.com/
$steamAPI = "https://www.littlesilly.xyz/json/SteamAPI.php";  // SteamAPI，我提供了两个API（在我博客获取），更推荐你自建。境外服务器推荐走本地，$steamAPI = "https://你的域名/json/SteamAPI.php"
